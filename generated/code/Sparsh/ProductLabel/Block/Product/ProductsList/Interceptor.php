<?php
namespace Sparsh\ProductLabel\Block\Product\ProductsList;

/**
 * Interceptor class for @see \Sparsh\ProductLabel\Block\Product\ProductsList
 */
class Interceptor extends \Sparsh\ProductLabel\Block\Product\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Rule\Model\Condition\Sql\Builder $sqlBuilder, \Magento\CatalogWidget\Model\Rule $rule, \Magento\Widget\Helper\Conditions $conditionsHelper, \Sparsh\ProductLabel\Helper\ProductLabelHelper $productLabelHelper, \Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Wishlist\Helper\Data $wishlistHelper, \Magento\Catalog\Helper\Product\Compare $compareHelper, array $data = [], ?\Magento\Framework\Serialize\Serializer\Json $json = null, ?\Magento\Framework\View\LayoutFactory $layoutFactory = null, ?\Magento\Framework\Url\EncoderInterface $urlEncoder = null, ?\Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository = null)
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $sqlBuilder, $rule, $conditionsHelper, $productLabelHelper, $postDataHelper, $wishlistHelper, $compareHelper, $data, $json, $layoutFactory, $urlEncoder, $categoryRepository);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductLabelHelper');
        return $pluginInfo ? $this->___callPlugins('getProductLabelHelper', func_get_args(), $pluginInfo) : parent::getProductLabelHelper();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPostDataHelper');
        return $pluginInfo ? $this->___callPlugins('getPostDataHelper', func_get_args(), $pluginInfo) : parent::getPostDataHelper();
    }

<?php
namespace Sparsh\ProductLabel\Model\ResourceModel\ProductLabels\Collection;

/**
 * Interceptor class for @see \Sparsh\ProductLabel\Model\ResourceModel\ProductLabels\Collection
 */
class Interceptor extends \Sparsh\ProductLabel\Model\ResourceModel\ProductLabels\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStoreFilter($tabId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($tabId);
    }
    ...
    public function addCustomerGroupFilter($tabId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCustomerGroupFilter', func_get_args(), $pluginInfo) : parent::addCustomerGroupFilter($tabId);
    }
    ...
    public function addData($table, $target, $linkedIds, $linkField)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addData', func_get_args(), $pluginInfo) : parent::addData($table, $target, $linkedIds, $linkField);
    }
